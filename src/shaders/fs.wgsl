[[stage(fragment)]]
fn main([[builtin(position)]] vpos: vec4<f32>, [[location(0)]] pos: vec4<f32>, [[location(1)]] uv: vec3<f32>, [[location(2)]] normal: vec3<f32>, [[location(3)]] color: vec3<f32>) -> [[location(0)]] vec4<f32> {
